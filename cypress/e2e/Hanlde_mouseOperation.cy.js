...
describe('Handle Tables', () => {
    ...
    it.skip('Double Click', () => {
        ...
        // Double click- Appraoch-1
        /*  cy.iframe('#iframeResult').find("button[ondblclick='myFunction()']").trigger('dblclick');
          cy.iframe('#iframeResult').find('#field2').should('have.value', 'jyotish');
          */

        // Double click- Appraoch-2
    ...
    it.only('Scrolling Page', () => {
        ...
        cy.get(':nth-child(1) > tbody > :nth-child(86) > :nth-child(1) > img').scrollIntoView({ duration: 8000 });
